...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab = findViewById(R.id.my_location);
    ...
    private void checkFirebaseSession(FirebaseUser user) {
        if (user != null) {
            ...
            Intent intent = new Intent(HomeActivity.this, StartUp.class);
                ...
                locationResult.addOnCompleteListener(this, new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful() && task.getResult() != null) {
                            ...
                            Snackbar mySnackbar = Snackbar.make(findViewById(R.id.my_location),
